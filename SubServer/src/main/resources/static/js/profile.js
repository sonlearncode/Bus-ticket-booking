document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeProfile() {
        ...
        async function fetchAndInitUser() {
            try {
                const response = await fetch('http://localhost:8080/busbooking/users/myinfo', {
                    method: 'GET',
                    headers: {
                ...
                function setupEditFunctionality() {
                    ...
                    if (editForm) {
                        editForm.addEventListener('submit', async function (e) {
                            ...
                            try {
                                const response = await fetch('http://localhost:8080/busbooking/users/update/info', {
                                    method: 'PUT',
                                    headers: {
    ...
    viewBookingsBtn.addEventListener('click', async function () {
        try {
            ...
            const response = await fetch('http://localhost:8080/busbooking/booking', {
                headers: {
